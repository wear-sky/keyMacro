...
public class MainFrame extends JFrame {
     ...
     * 创建配置按钮
     */
    private final JButton createConfigButton;

    /**
     * 选择配置下拉列表框
     */
    private final JComboBox<String> selectConfigComboBox;
     ...
     * 导入配置按钮
     */
    private final JButton inputConfigButton;

    /**
     * 导出配置按钮
     */
    private final JButton outputConfigButton;

    /**
     * 切换配置快捷键录入框
     */
    private final JTextField switchConfigField;

    /**
     * 宏表格
     */
    private final JTable macrosTable;

    /**
     * 创建宏按钮
     */
    private final JButton createMacroButton;

    /**
     * 修改宏按钮
     */
    private final JButton modifyMacroButton;

    /**
     * 删除宏按钮
     */
    private final JButton deleteMacroButton;

    /**
     * 清除宏按钮
     */
    private final JButton clearMacroButton;

    /**
     * 开关快捷键录入框
     */
    private final JTextField switchField;
    ...
    public MainFrame() {
        ...
        trayIcon = new TrayIcon(Objects.requireNonNull(IconUtils.getTrayIcon()), "显示主页面", popupMenu);
        ...
        selectConfigComboBox = new JComboBox<>();
        ...
        if (systemConfigFile.exists()) {
            try (FileReader fileReader = new FileReader(systemConfigFile); BufferedReader bufferedReader = new BufferedReader(fileReader)) {
                try {
    ...
    private void writeConfigToFile() {
        ...
        String configName = Objects.requireNonNull(selectConfigComboBox.getSelectedItem()).toString().trim();
        ...
        try (FileWriter fileWriter = new FileWriter(configFile); BufferedWriter bufferedWriter = new BufferedWriter(fileWriter)) {
    ...
    private boolean copyFile(File selectedFile, File newFile) {
        ...
        try (BufferedInputStream bufferedInputStream = new BufferedInputStream(new FileInputStream(selectedFile)); BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(newFile))) {
    ...
    class CreateConfigButtonListener implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            String configName = JOptionPane.showInputDialog(MainFrame.this, "配置名称", "创建配置", JOptionPane.PLAIN_MESSAGE);
     ...
     *
     */
    static class ConfigFileFilter extends FileFilter {
     ...
     *
     */
    static class OutputDirectoryFilter extends FileFilter {
     ...
     *
     */
    static class SwitchConfigFieldListener implements FocusListener {
     ...
     *
     */
    public static class MacrosTableModel extends DefaultTableModel {
