...
public abstract class MacroDialog extends JDialog {
	...
	public MacroDialog(Frame owner, boolean modal) {
		...
		targetKeyList = new JList<String>();
	 ...
	 *
	 */
	class TriggerKeyFieldFocusAdapter extends FocusAdapter {
	 ...
	 *
	 */
	class TriggerKeyFieldKeyAdapter extends KeyAdapter {
	...
	class LeftClickListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			DefaultListModel<String> defaultListModel = (DefaultListModel<String>) targetKeyList.getModel();
			defaultListModel.addElement("~" + Constants.DdCode.LEFT_CLICK_DOWN.toString());
			defaultListModel.addElement("~" + Constants.DdCode.LEFT_CLICK_UP.toString());
		}
	}
	...
	class RightClickListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			DefaultListModel<String> defaultListModel = (DefaultListModel<String>) targetKeyList.getModel();
			defaultListModel.addElement("~" + Constants.DdCode.RIGHT_CLICK_DOWN.toString());
			defaultListModel.addElement("~" + Constants.DdCode.RIGHT_CLICK_UP.toString());
		}
	}
	...
	class MButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			DefaultListModel<String> defaultListModel = (DefaultListModel<String>) targetKeyList.getModel();
			defaultListModel.addElement("~" + Constants.DdCode.MBUTTON_DOWN.toString());
			defaultListModel.addElement("~" + Constants.DdCode.MBUTTON_UP.toString());
		}
	}
	...
	class XButton2Listener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			DefaultListModel<String> defaultListModel = (DefaultListModel<String>) targetKeyList.getModel();
			defaultListModel.addElement("~" + Constants.DdCode.XBUTTON2_DOWN.toString());
			defaultListModel.addElement("~" + Constants.DdCode.XBUTTON2_UP.toString());
		}
	}
	...
	class XButton1Listener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			DefaultListModel<String> defaultListModel = (DefaultListModel<String>) targetKeyList.getModel();
			defaultListModel.addElement("~" + Constants.DdCode.XBUTTON1_DOWN.toString());
			defaultListModel.addElement("~" + Constants.DdCode.XBUTTON1_UP.toString());
		}
	}
	...
	class MouseMoveButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!xPointText.isEmpty() && !yPointText.isEmpty()) {
				int xPoint = Integer.valueOf(xPointText);
				int yPoint = Integer.valueOf(yPointText);
	...
	class DelayButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!delayText.isEmpty()) {
				long delay = Long.valueOf(delayText);
	 ...
	 *
	 */
	class NumberTextFieldListener extends KeyAdapter {
